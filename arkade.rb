...
def new_rides
  ...
  if ride == "a"
    ...
    if height_twizzler == "five foot two"
    ...
    if the_one == "b"
      ...
      if height_for_cup == "four foot three"
        puts "Ok! You can go on the ride."
      else
      ...
      if height_for_abduct == "four foot seven"
        puts "Ok! You can go on the ride."
      else
      ...
      if height_for_tunnel == "five foot two"
        puts "Ok! You can go on the ride."
      else
    ...
    if the_second == "a"
      ...
      if height_twizzler_second == "five foot two"
        puts "Ok! You can go on the ride."
      else
        puts "Sorry. You're not ready for the twisting twizzlers yet."
      end
      ...
      if height_for_abduct_second == "four foot seven"
        puts "Ok! You can go on the ride."
      else
        puts "Sorry. The aliens can't abduct you today."
      end
      ...
      if height_for_tunnel_second == "five foot two"
        puts "Ok! You can go on the ride."
      else
        puts "Sorry. No doom for you."
      end
    ...
    if height_abduct == "four foot seven"
      puts "Ok! You can go on the ride."
    else
      puts "Sorry. The aliens can't abduct you today."
    end
    ...
    if the_third == "a"
      ...
      if height_twizzler_third == "five foot two"
        puts "Ok! You can go on the ride."
      else
        puts "Sorry. You're not ready for the twisting twizzlers yet."
      end
      ...
      if height_for_tunnel_third == "five foot two"
        puts "Ok! You can go on the ride."
      else
        puts "Sorry. No doom for you."
      end
    ...
    if height_tunnel == "five foot two"
      puts "Ok! You can go on the ride."
    else
      puts "Sorry. No doom for you."
    end
    ...
    if the_fourth == "a"
      ...
      if height_twizzler_four == "five foot two"
        puts "Ok! You can go on the ride."
      else
        puts "Sorry. You're not ready for the twisting twizzlers yet."
      end
      ...
      if height_cup_fourth == "four foot"
        puts "Ok! You can go on the ride."
      else
        puts "Sorry. No cupcakes for you!"
      end
      ...
      if height_for_abduct_fourth == "four foot seven"
        puts "Ok! You can go on the ride."
      else
        puts "Sorry. The aliens can't abduct you today."
      end
